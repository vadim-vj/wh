...
INSERT INTO `categories` (`id`, `name`, `pattern`, `parent_id`) VALUES (1,'Защита','защита',0);
INSERT INTO `categories` (`id`, `name`, `pattern`, `parent_id`) VALUES (2,'Шлемы','шлем',1);
INSERT INTO `categories` (`id`, `name`, `pattern`, `parent_id`) VALUES (3,'Маски, визоры','маска|визор|маска\\s*-\\s*визор|визор\\s*-\\s*маска',1);
INSERT INTO `categories` (`id`, `name`, `pattern`, `parent_id`) VALUES (4,'Нагрудники','нагрудник',1);
INSERT INTO `categories` (`id`, `name`, `pattern`, `parent_id`) VALUES (5,'Налокотники','налокотник|защитаs+локтя?',1);
INSERT INTO `categories` (`id`, `name`, `pattern`, `parent_id`) VALUES (6,'Щитки','щитки',1);
...
INSERT INTO `categories` (`id`, `name`, `pattern`, `parent_id`) VALUES (9,'Клюшки','клюшк(?:а|и)?',0);
...
INSERT INTO `categories` (`id`, `name`, `pattern`, `parent_id`) VALUES (14,'Коньки','коньки',0);
...
INSERT INTO `categories` (`id`, `name`, `pattern`, `parent_id`) VALUES (19,'Сумки','сумка',0);
INSERT INTO `categories` (`id`, `name`, `pattern`, `parent_id`) VALUES (20,'Одежда/обувь',NULL,0);
...
INSERT INTO `categories` (`id`, `name`, `pattern`, `parent_id`) VALUES (28,'Аксессуары',NULL,0);
INSERT INTO `categories` (`id`, `name`, `pattern`, `parent_id`) VALUES (29,'Гамаши/рейтузы','гамаши|рейтузы',28);
...
INSERT INTO `categories` (`id`, `name`, `pattern`, `parent_id`) VALUES (38,'Экипировка вратаря',NULL,28);
...
INSERT INTO `categories` (`id`, `name`, `pattern`, `parent_id`) VALUES (42,'Сетки и гасители','сетка|гаситель',0);
...
CREATE TABLE `products` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`,`model`,`article`,`brand_id`,`category_id`),
  KEY `brand_id` (`brand_id`),
  KEY `category_id` (`category_id`),
  CONSTRAINT `brand_id` FOREIGN KEY (`brand_id`) REFERENCES `brands` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `category_id` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
