...
Изучение git internals сначала, освоение высокоуровневых концепций через них, лично мне кажется хоть и более трудным, но дающим более глубокое понимание. Хотя, как и говорилось, такая глубина практически для всех избыточна.
...
- файл на диске: `git hash-file [-w] <file>`
