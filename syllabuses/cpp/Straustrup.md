...
- создание пользовательских типов и алгоритмов, работающих с ними - один из главных инструментов предотвращения ошибок. Это упрощает программирование, увеличивает возможности компилятора по поиску ошибок
