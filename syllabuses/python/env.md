...
Стандартным способом передачи аргументов:

```shell
$ python3 -m <module> <params>
```

передав `-h/--help`. Например:

```shell
# так запускается модуль
$ python -m timeit -s 'setup here' 'benchmarked code here'
# а это как раз получение справки
$ python -m timeit -h
```
