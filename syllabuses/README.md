`<!-- Список не обновляется, ссылки могут быть неактуальными. КОнспектирование новых книг ведется без добавления инфы сюда -->`

### Конспекты прочитанного

#### Python
- [Федоров Д., Программирование на Python](python/beginner/Fedorov.md)
- [Харрисон М., Как устроен Python](python/beginner/Harrison.md)
- [Westra E., Modular Programming](python/modular/Westra.md)
...
#### C++
- [Страуструп Б., Язык программирования C++](cpp/Straustrup.md)
...
- [Маркотт И., Отзывчивый веб-дизайн](html_css/responsive/Markott/_.md)
